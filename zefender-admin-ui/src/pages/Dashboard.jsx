  ...
  return (
    <div className={`dash-root ${theme === "light" ? "light-theme" : ""}`}>
      <style>{`
        ...
        :root {
          --bg: #050507; --panel: #0a0a12;
          --border: rgba(99,102,241,0.15); --text: #e2e8f0;
          --text-muted: #4f4f7a; --accent: #6366f1;
          --grid: rgba(99,102,241,0.02); --card: #0d0d18; --field: #13131f;
        }
        .light-theme {
          --bg: #f8fafc; --panel: #ffffff;
          --border: rgba(99,102,241,0.1); --text: #1e293b;
          --text-muted: #64748b; --accent: #4f46e5;
          --grid: rgba(79,70,229,0.03); --card: #ffffff; --field: #f1f5f9;
        }
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .logo-icon {
          ...
          box-shadow: 0 0 14px rgba(99,102,241,0.4); flex-shrink: 0;
        }
        ...
        .nav-section { font-size: 9px; color: var(--text-muted); letter-spacing: 0.2em; padding: 0 20px; margin-bottom: 8px; }
        ...
        .nav-item.active { color: var(--accent); background: rgba(99,102,241,0.08); border-left-color: var(--accent); }
        .nav-icon { font-size: 14px; width: 20px; text-align: center; }

        .sidebar-bottom { margin-top: auto; padding: 16px 20px; border-top: 1px solid rgba(99,102,241,0.1); }

        .role-badge { font-size: 9px; color: var(--text-muted); letter-spacing: 0.15em; margin-bottom: 10px; }

        .logout-btn {
          display: flex; align-items: center; gap: 8px; width: 100%;
          background: none; border: 1px solid rgba(239,68,68,0.2); border-radius: 7px;
          padding: 9px 12px; color: #f87171; font-family: 'Space Mono', monospace;
        ...
        .topbar-title { font-family: 'Syne', sans-serif; font-size: 16px; font-weight: 800; color: var(--text); letter-spacing: 0.06em; }

        .topbar-right { display: flex; align-items: center; gap: 16px; font-size: 10px; color: var(--text-muted); letter-spacing: 0.1em; }

        .theme-toggle {
          background: none; border: 1px solid var(--border); border-radius: 8px;
          width: 32px; height: 32px; display: flex; align-items: center; justify-content: center;
          cursor: pointer; color: var(--text); font-size: 14px; transition: all 0.2s;
        }
        .theme-toggle:hover { background: rgba(99,102,241,0.1); border-color: var(--accent); }

        .online-badge {
          display: flex; align-items: center; gap: 5px;
          background: rgba(16,185,129,0.08); border: 1px solid rgba(16,185,129,0.2);
          border-radius: 20px; padding: 4px 10px; color: #10b981; font-size: 10px;
        }
        .online-dot {
          width: 5px; height: 5px; border-radius: 50%;
          background: #10b981; box-shadow: 0 0 5px #10b981; animation: blink 2s infinite;
        }
